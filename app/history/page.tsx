...
export default async function HistoryPage({
  ...
  const detailPromise = loadMonthDetail(session.user.companyId, session.user.id, selectedYm);
  const summariesPromise = loadMonthSummaries(session.user.companyId, session.user.id, months);
